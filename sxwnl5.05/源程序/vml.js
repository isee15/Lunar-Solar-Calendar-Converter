...
var tu1={
 ...
 init:function(can){ //初始化坐标等
  ...
  p.stroked=false; p.fillcolor='#D0D0D0';
...
var tu2={
 ...
 init:function(can){
  ...
  p.p_save();
  p2 = ht.textbox(this.x0+this.eR*1.2-20,this.y0,60,15,'交线');  p2.filled=false;  p2.stroked=false;
  this.zbTxt=p2;

  this.zxx = ht.shape(''); //中心线
  this.dbj = ht.oval(0,0,6,6); //地球北极
 ...
 line1:function(a,hd){
  ...
  if(!hd){ //在赤道贝塞尔坐标中显示北极
   ...
   if(a.I[1]<Math.PI/2) this.dbj.fillcolor='#00a0FF'; else this.dbj.fillcolor='#000000'; //北极在阳光下，置为高亮
...
var tu3={
 ...
 draw:function(F, J0,W0, eR, jb, tylx){ //jb局部放大参数
  ...
  this.showDitu();
  this.drawJWQ(24,11);
  A.p_cls(); B.p_cls(); C.p_cls(); D.p_cls();
  ...
  this.lineArr( F.q4, A ); //日出日没食甚线线2,第2根
  ...
  A.p_save(); B.p_save(); C.p_save(); D.p_save();
