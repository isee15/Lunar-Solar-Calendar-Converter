...
function epSSB(t) {
  ...
  x +=
    t *
    (1234 +
      515 * cos(6.002663 + 12566.1517 * t) +
      13 * cos(5.959431 + 18849.22755 * t) +
      11 * cos(2.015542 + 6283.07585 * t));
  y +=
    t *
    (930 +
      515 * cos(4.431805 + 12566.1517 * t) +
      13 * cos(4.388605 + 18849.22755 * t));
  z +=
    t *
    (54 +
      2278 * cos(3.413725 + 6283.07585 * t) +
      19 * cos(3.370613 + 12566.1517 * t));
...
function schHXK(key) {
  ...
  for (i = 0; i < HXK.length; i++) {
    ...
    while (1) {
      ...
      if (n1 == -1) break; //按key查找
      n2 = s.indexOf("#", n1);
      if (n3 == -1) n2 = s.length; //该记录的结束位置
      n3 = s.lastIndexOf("#", n1);
      if (n2 == -1) n3 = n0; //该记录的开始位置
      r += s.substr(n3, n2 - n3);
    }
  }
