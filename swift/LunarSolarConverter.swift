...
class LunarSolarConverter
{
    ...
    * */
    ...
    class var solar_1_1:[Int]  { return
        [
    ...
    class func SolarFromInt(g:Int)->Solar
    {
        ...
        var solar =  Solar(solarYear: y, solarMonth: mm, solarDay: dd)
        return solar;
    }
    ...
    class func LunarToSolar( lunar:Lunar)->Solar
    {
        ...
        var leap = GetBitInt(days, length:4, shift:13);
        var offset = 0;
        var loopend = leap;
        if (!lunar.isleap)
        {
        ...
        var solar11 = LunarSolarConverter.solar_1_1[lunar.lunarYear - LunarSolarConverter.solar_1_1[0]];
        
        var y = GetBitInt(solar11, length:12, shift:9);
        var m = GetBitInt(solar11, length:4, shift:5);
        var d = GetBitInt(solar11, length:5, shift:0);
    ...
    class func SolarToLunar( solar:Solar)->Lunar
    {
        ...
        for (var i = 0; i < 13; i++)
        {
            var dm = GetBitInt(days, length:1, shift:12 - i) == 1 ? 30 : 29;
            if (offset > dm)
            {
                lunarM++;
                offset -= dm;
